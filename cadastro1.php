					...
					<div class="nav-header">
						...
						<nav id="fh5co-menu-wrap" role="navigation">
							<ul class="sf-menu" id="fh5co-primary-menu">
								...
								<?php
								$user = $_GET["user"];
								echo "<a href='index_$user.html'>Home</a>"; ?>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-5 col-md-offset-3 text-center">
							...
							<h3 class="section-title">Cadastro de Passageiro</h3>
							
							
							<?php
							$user = $_GET["user"];
							echo "<form method='post' action='cadastro.php?user=$user' class='contact-form'>";
							?>
							...
							<div class="form-group" id="centro">
									...
									<label for="nascimento" class="sr-only">Nascimento</label>
									<input type="date" class="form-control" name="nasc" placeholder="Nascimento">
							...
							<div class="form-group" id="centro">
									...
									<label for="Quantidade de bagagens" class="sr-only">Quantidade de bagagens</label>
									<input type="text" class="form-control" name="QtdBag" placeholder="Quantidade de bagagens">
							...
							<div class="form-group" id="centro">
									...
									<input type="submit" class="form-control" value="Cadastrar" id="btn-submit"  class="btn btn-send-message btn-md">
								
								</div>
								<?php
					$user = $_GET["user"];
					echo "<a href='index_$user.html' class='form-control' id='btn-submit' value='Voltar' class='btn-send-message btn-md'>Voltar</a>";
