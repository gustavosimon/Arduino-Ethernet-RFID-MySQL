  ...
  <!-- 
	...
	<body>
		...
		<footer>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-5 col-md-offset-3 text-center">
							...
							<h3 class="section-title">Login - Passageiro</h3>
							<?php
			...
			$login = "SELECT `RG`, `Senha` FROM `passageiros` WHERE `passageiros`.`RG` = $rg AND `passageiros`.`Senha` = '$senha'";

			$sql = mysql_query($login);

			$linha = mysql_fetch_array($sql); 
			
			if ($linha[0] == $rg && $linha[1] == $senha){
				
				echo "<meta http-equiv='refresh' content=0;url='passageiros.php?rg=$rg&user=passageiro'>";
